...
public class CPainting extends Canvas implements MouseListener {
  ...
  private Color[][][] mCouleurStocke = new Color[256][256][256];
  
  /******************************************************************************
   * Titre : public getR(int iColor) Description : Retourner le couleur R
   ******************************************************************************/
  public int getR(int iColor){
	  return (iColor>>16) & 0x00FF;
  }
  
  /******************************************************************************
   * Titre : public getR(int iColor) Description : Retourner le couleur G
   ******************************************************************************/
  public int getG(int iColor){
	  return (iColor>>8) & 0x00FF;
  }
  
  /******************************************************************************
   * Titre : public getR(int iColor) Description : Retourner le couleur B
   ******************************************************************************/
  public int getB(int iColor){
	  return iColor & 0x00FF;
  }
  ...
  public CPainting(Dimension pDimension, PaintingAnts pApplis) {
    ...
    this.setBackground(new Color(mCouleurFond));
    ...
    synchronized (mMutexCouleurs) {
      for (i = 0; i < mDimension.width; i++) {
        for (j = 0; j < mDimension.height; j++) {
        	...
        	pGraphics.setColor(new Color(mCouleurs[i][j]));
    ...
    synchronized (mMutexCouleurs) {
      if (!mSuspendu) {
        // on colorie la case sur laquelle se trouve la fourmi
    	  ...
    	  mGraphics.setColor(new Color(c));
            ...
            for (j = 0; j < 3; j++) {
              ...
              for (k = 0; k < 3; k++) {
                for (l = 0; l < 3; l++) {
                  ...
                  R += CPainting.mMatriceConv9[k][l] * getR(mCouleurs[m][n]);
                  G += CPainting.mMatriceConv9[k][l] * getG(mCouleurs[m][n]);
                  B += CPainting.mMatriceConv9[k][l] * getB(mCouleurs[m][n]);
                }
              }
              //lColor = new Color((int) R, (int) G, (int) B);
              lColor = ((int)R<<16) + ((int)G<<8) + (int)B;

              //mGraphics.setColor(lColor);
              //mGraphics.setColor(new Color(lColor));
              if(mCouleurStocke[(int)R][(int)G][(int)B] == null){
            	  mCouleurStocke[(int)R][(int)G][(int)B] = new Color(lColor);
              }
              mGraphics.setColor(mCouleurStocke[(int)R][(int)G][(int)B]);
            ...
            for (j = 0; j < 5; j++) {
              ...
              for (k = 0; k < 5; k++) {
                for (l = 0; l < 5; l++) {
                  ...
                  R += CPainting.mMatriceConv25[k][l] * getR(mCouleurs[m][n]);
                  G += CPainting.mMatriceConv25[k][l] * getG(mCouleurs[m][n]);
                  B += CPainting.mMatriceConv25[k][l] * getB(mCouleurs[m][n]);
                }
              }
            ...
            for (j = 0; j < 7; j++) {
              ...
              for (k = 0; k < 7; k++) {
                for (l = 0; l < 7; l++) {
                  ...
                  R += CPainting.mMatriceConv49[k][l] * getR(mCouleurs[m][n]);
                  G += CPainting.mMatriceConv49[k][l] * getG(mCouleurs[m][n]);
                  B += CPainting.mMatriceConv49[k][l] * getB(mCouleurs[m][n]);
                }
              }
